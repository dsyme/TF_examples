...
type V<'T>(shape: Shape, eval: (TFGraph -> TFOutput)) =
    ...
    static member (+) (v1: V<'T>, v2: V<'T>) : V<'T> = V (Shape.EquivShapes v1.Shape v2.Shape, fun graph -> graph.Add(v1.Apply(graph), v2.Apply(graph)))

    static member (-) (v1: V<'T>, v2: V<'T>) : V<'T> = V (Shape.EquivShapes v1.Shape v2.Shape, fun graph -> graph.Sub(v1.Apply(graph), v2.Apply(graph)))

    static member ( * ) (v1: V<'T>, v2: V<'T>) : V<'T> = (V (Shape.EquivShapes v1.Shape v2.Shape, fun graph -> graph.Mul(v1.Apply(graph), v2.Apply(graph))))

    static member (/) (v1: V<'T>, v2: V<'T>) : V<'T> = (V (Shape.EquivShapes v1.Shape v2.Shape, fun graph -> graph.Div(v1.Apply(graph), v2.Apply(graph))))
